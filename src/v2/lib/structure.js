...
Return ONLY a single valid JSON object (no prose, no markdown fences) with exactly these keys:
{
  ...
  "recruitment_method": "how the survivor was recruited, e.g. deception / false job offer, or empty string",
  "control_method": "how they were controlled, e.g. document retention, debt bondage, threats, or empty string",
...
export function structuredToFields(s) {
  const rows = [
    ...
    ['Location', s.location],
    ['Recruitment method', s.recruitment_method],
    ['Control method', s.control_method],
