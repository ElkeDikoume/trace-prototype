...
export default function DocsScreen() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-8 text-center">
      <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-tracev2-card border border-tracev2-border text-tracev2-subtle">
      ...
      <h1 className="mt-3 text-base font-semibold text-tracev2-text">Documents</h1>
      <p className="mt-1 max-w-[16rem] text-xs leading-relaxed text-tracev2-subtle">
