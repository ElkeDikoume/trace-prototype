  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 px-4 pb-2 pt-3">
        <h2 className="flex items-center text-lg font-bold text-tracev2-text">
          Records
          <InfoButton label="Every document TRACE generates is stored here. In full deployment, submitted documents sync to the cluster coordination platform automatically. Documents marked 'Draft' exist only on this device." />
        </h2>
